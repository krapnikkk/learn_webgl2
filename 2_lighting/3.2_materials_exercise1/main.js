async function main() {
    ...
    function render(time) {
        ...
        lightingShader.setVec3("material.ambient", glMatrix.vec3.fromValues(0.0, 0.1, 0.06));
        lightingShader.setVec3("material.diffuse", glMatrix.vec3.fromValues(0.0, 0.5, 0.5));
