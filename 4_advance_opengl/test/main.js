...
async function main() {
    ...
    function render(time) {
        ...
        gl.activeTexture(gl.TEXTURE0);
        // gl.bindTexture(gl.TEXTURE_CUBE_MAP, cubemapTexture); //INVALID_OPERATION: bindTexture: textures can not be used with multiple targets
        gl.bindTexture(gl.TEXTURE_CUBE_MAP, cubemapTexture); //GL_INVALID_OPERATION: Two textures of different types use the same sampler location.
        gl.drawArrays(gl.TRIANGLES, 0, 36);
        gl.bindVertexArray(null);
