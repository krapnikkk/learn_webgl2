...
async function main() {
    ...
    let diffuseMap = await loadTexture(gl, "../../resources/textures/bricks2.jpg");
    let normalMap = await loadTexture(gl, "../../resources/textures/bricks2_normal.jpg");
    let heightMap = await loadTexture(gl,"../../resources/textures/bricks2_disp.jpg");
