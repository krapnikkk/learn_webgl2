async function main() {
    ...
    canvas.onmousemove = (e) => {
        ...
        let x = Math.cos(glMatrix.glMatrix.toRadian(yaw)) * Math.cos(glMatrix.glMatrix.toRadian(pitch));
        let y = Math.sin(glMatrix.glMatrix.toRadian(pitch));
        let z = Math.sin(glMatrix.glMatrix.toRadian(yaw)) * Math.cos(glMatrix.glMatrix.toRadian(pitch));
    ...
    function render(time) {
        ...
        glMatrix.mat4.perspective(projection, glMatrix.glMatrix.toRadian(fov), gl.canvas.width / gl.canvas.height, 0.1, 100)
