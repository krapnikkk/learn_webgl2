async function main() {
    ...
    function render(time) {
        ...
        glMatrix.mat4.rotate(model, model, -55, glMatrix.vec3.fromValues(1.0, 0.0, 0.0));
        glMatrix.mat4.translate(view, view, glMatrix.vec3.fromValues(0.0, 0.0, -3.0));
        glMatrix.mat4.perspective(projection, 45, gl.canvas.width / gl.canvas.height, 0.1, 100)
