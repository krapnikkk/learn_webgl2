async function main() {
    ...
    function render(time) {
        ...
        glMatrix.mat4.rotate(transform, transform, time, glMatrix.vec3.fromValues(0.0, -0.0, 1.0));
        ...
        glMatrix.mat4.translate(transform, transform, glMatrix.vec3.fromValues(0.5, -0.5, 0.0));
        let sacleAmount = Math.sin(time);
        glMatrix.mat4.scale(transform, transform, glMatrix.vec3.fromValues(sacleAmount, sacleAmount, sacleAmount));
