...
async function main() {
    ...
    let obj = new Model(gl, '../../resources/objects/LeePerrySmith');
    obj.material = {
        ambientMap: 'Map-COL.jpg',
        specular:[0.06,0.06,0.06]
        // specularMap: 'Map-SPEC.jpg',
    }
    obj.program = modelShader;
    await obj.loadModel(['LeePerrySmith.glb'])
    ...
    function render(time) {
        ...
        glMatrix.mat4.translate(model, model, glMatrix.vec3.fromValues(0, 0, -20));
